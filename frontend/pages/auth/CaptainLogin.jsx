...
const CaptainLogin = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Implement captain login logic here
    console.log('Captain logging in:', { email, password });
  };
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-white">
      ...
      <div className="relative z-10 w-full max-w-xl bg-white/90 p-12 rounded-3xl shadow-2xl border border-gray-200 min-h-[600px] flex flex-col justify-center">
        ...
        <h2 className="text-3xl font-bold text-black mb-6 text-center">Captain Login</h2>
        <p className="text-center text-gray-600 mb-8">Login to start accepting rides</p>
        ...
        <p className="text-sm text-center text-gray-600 mt-6">
          ...
          <Link to="/captain-register" className="text-black font-medium underline hover:text-gray-800">
            Register as Captain
          </Link>
        </p>
        <Link
